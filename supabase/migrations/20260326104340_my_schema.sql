CREATE UNIQUE INDEX profiles_index_number_key ON public.profiles USING btree (index_number);

alter table "public"."profiles" add constraint "profiles_index_number_key" UNIQUE using index "profiles_index_number_key";
